...
public:
    ...
    std::vector<glm::vec3> createVertices(std::vector<glm::vec3>  pos, std::vector<glm::vec3>  u,std::vector<glm::vec3>  v, std::vector<glm::vec3>  tan, float radius, int numberOfPoints);
