...
public:
    ...
    std::vector<glm::vec3> getOnlyPos(std::vector<glm::vec3> poly,std::vector<glm::vec3> *tangent );
    std::vector<glm::vec3> createShape(std::vector<glm::vec3> poly, std::vector<glm::vec3> *tri , float radius, int numberOfPoints);
